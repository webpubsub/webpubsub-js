...
export declare const ChannelAuthorizerProxy: (webpubsub: any, authOptions: InternalAuthOptions, channelAuthorizerGenerator: ChannelAuthorizerGenerator) => ChannelAuthorizationHandler;
