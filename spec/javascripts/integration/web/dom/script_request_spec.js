...
Integration.describe("ScriptRequest", function() {
  ...
  beforeEach(function() {
    ...
    receiver = Webpubsub.Integration.ScriptReceivers.create(callback);
  ...
  it("should allow cleaning up", async function() {
    ...
    var receiver = Webpubsub.Integration.ScriptReceivers.create(callback);
