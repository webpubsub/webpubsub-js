...
describe("ChannelAuthorizerProxy", function() {
  ...
  describe("initialization", function(){
    it("should call the deprecated authorizer properly", function(){
      ...
      channelAuthorizer = ChannelAuthorizerProxy(webpubsub, authOptions, deprecatedAuthorizerGenerator)
      
      const params = { socketId: "1.23", channelName: "private-test-channel"};
      const callback = function() {};
      channelAuthorizer(params, callback);

      expect(webpubsub.channel.calls.count()).toEqual(1);
      expect(webpubsub.channel).toHaveBeenCalledWith('private-test-channel');
