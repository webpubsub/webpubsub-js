...
describe("PresenceChannel", function() {
  ...
  beforeEach(function() {
    ...
    channel = new PresenceChannel("presence-test", webpubsub);
  });
  ...
  describe("after authorizing", function() {
    ...
    describe("#handleEvent", function() {
      it("should not emit webpubsub_internal:* events", function() {
        ...
        channel.handleEvent({event: "webpubsub_internal:test"});

        expect(callback).not.toHaveBeenCalled();
      });

      describe("on webpubsub_internal:subscription_succeeded", function() {
        it("should emit webpubsub:subscription_succeeded with members", function() {
          var callback = jasmine.createSpy("callback");
    ...
    describe("after subscribing", function() {
      ...
      describe("on webpubsub_internal:member_added", function() {
        it("should add a new member", function() {
          channel.handleEvent({
            event: "webpubsub_internal:member_added",
            data: {
              user_id: "C",
              user_info: "user C"
            }
        ...
        it("should emit webpubsub:member_added with new member's data", function() {
          var callback = jasmine.createSpy("callback");
          channel.bind("webpubsub:member_added", callback);
        ...
        it("should emit webpubsub:member_added with updated member's data", function() {
          var callback = jasmine.createSpy("callback");
          channel.bind("webpubsub:member_added", callback);
      ...
      describe("on webpubsub_internal:member_removed", function() {
        it("should remove an existing member", function() {
          channel.handleEvent({
            event: "webpubsub_internal:member_removed",
            data: {
              user_id: "B"
            }
          });
        ...
        it("should emit webpubsub:member_removed with removed member's data", function() {
          var callback = jasmine.createSpy("callback");
          channel.bind("webpubsub:member_removed", callback);
        ...
        it("should not emit webpubsub:member_removed if removed member didn't exist", function() {
          var callback = jasmine.createSpy("callback");
          channel.bind("webpubsub:member_removed", callback);
