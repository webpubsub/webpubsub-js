...
describe('Config', function() {
  ...
  it('should override config with supplied options', function() {
    let opts = {
      ...
      wsHost: 'ws-spec.webpubsub.com',
      wsPort: 2020,
      wssPort: 2021,
      httpHost: 'socksjs-spec.webpubsub.com',
      httpPort: 1020,
      httpsPort: 1021,
      enableStats: true
    };
  ...
  describe('auth', function(){
    ...
    it('should use deprecated auth options', function() {
      let opts = {
        ...
        authEndpoint: '/webpubsub/spec/auth',
        auth: {
          params: { foo: 'bar' },
          headers: { spec: 'header' }
        },
      ...
      const webpubsub = {};
      let config = Config.getConfig(opts, webpubsub);
    ...
    it('should create ChannelAuthorizerProxy if authorizer is set', function() {
      ...
      const webpubsub = { channel: jasmine.createSpy('channel').and.returnValue(channel) };
      let config = Config.getConfig(opts, webpubsub);
