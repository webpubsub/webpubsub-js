...
const urlStore = {
  ...
  urls: {
    ...
    encryptedChannelSupport: {
      fullUrl:
        'https://github.com/webpubsub/webpubsub-js/tree/cc491015371a4bde5743d1c87a0fbac0feb53195#encrypted-channel-support'
    }
  }
};

/** Builds a consistent string with links to webpubsub documentation
 *
