...
import {
    ConnectionCallbacks, ErrorCallbacks,
    HandshakeCallbacks
} from './callbacks';
...
/** Manages connection to Webpubsub.
 *
 ...
 * - pongTimeout - time for Webpubsub to respond with pong before reconnecting
 *
...
export default class ConnectionManager extends EventsDispatcher {
  ...
  /** Establishes a connection to Webpubsub.
   *
  ...
  private buildConnectionCallbacks(
    ...
    return Collections.extend<ConnectionCallbacks>({}, errorCallbacks, {
      ...
      ping: () => {
        this.send_event('webpubsub:pong', {});
      },
      activity: () => {
        this.resetActivityCheck();
      },
